...
class Musculo:
    ...
    nome_grupamento: Mapped[str] = mapped_column(ForeignKey("grupamento.nome_grupamento"), unique=True)
    id_usuario:      Mapped[int] = mapped_column(ForeignKey("usuario.id_usuario"), unique=True, nullable=True)
...
class Exercicio:
    ...
    id_musculo:     Mapped[int] = mapped_column(ForeignKey("musculo.id_musculo"), unique=True)
    id_usuario:     Mapped[int] = mapped_column(ForeignKey("usuario.id_usuario"), unique=True, nullable=True)
    id_aparelho:    Mapped[int] = mapped_column(ForeignKey("aparelho.id_aparelho"), unique=True, nullable=True)
...
class FichaTreino:
    ...
    id_usuario:            Mapped[int] = mapped_column(ForeignKey("usuario.id_usuario"), unique=True)
...
class DivisaoTreino:
    ...
    id_ficha_treino: Mapped[int] = mapped_column(ForeignKey("ficha_treino.id_ficha_treino"), primary_key=True)
...
class DivisaoExercicio:
    ...
    id_ficha_treino:  Mapped[int] = mapped_column(ForeignKey("divisao_treino.id_ficha_treino"), primary_key=True)
    divisao:          Mapped[str] = mapped_column(ForeignKey("divisao_treino.divisao"), primary_key=True)
    id_exercicio:     Mapped[int] = mapped_column(ForeignKey("exercicio.id_exercicio"), primary_key=True)
    series:           Mapped[int]
    reps:             Mapped[str]
...
class SerieRelatorio:
    ...
    id_relatorio_treino: Mapped[int] = mapped_column(ForeignKey("relatorio_treino.id_relatorio_treino"), primary_key=True)
    id_exercicio:        Mapped[int] = mapped_column(ForeignKey("divisao_exercicio.id_exercicio"), primary_key=True)
    divisao:             Mapped[str] = mapped_column(ForeignKey("divisao_exercicio.divisao"), primary_key=True)
    id_ficha_treino:     Mapped[int] = mapped_column(ForeignKey("divisao_exercicio.id_ficha_treino"), primary_key=True)
