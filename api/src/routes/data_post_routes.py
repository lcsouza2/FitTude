...
from api.src.security.authentication import TokenService
from api.src.connections import AsyncSession
...
from api.src.utils import exclude_falsy_from_dict
from api.database import db_mapping
...
async def bind_set_to_report(
    ...
    await _execute_insert(
        ...
        values=[exclude_falsy_from_dict(i.model_dump(exclude_none=True)) for i in sets],
        error_mapping=[
            {
